...
**55,033 rows across 13 tables**, of which 10 are the tables your
...
Or open `data/APS-02.db` in any SQLite client. Nothing to install, nothing to import.
...
In `APS-02.db` the money columns are declared `TEXT`. That is deliberate: SQLite's NUMERIC
...
```bash
python3 tools/validate_conformance.py data/APS-02.db     # or point it at your own export
```
