...
3. `data/queries/starter_queries.sql` — run them against `data/APS-02.db`. Ten minutes of running real queries will change what you design.
...
```
<TeamName>_APS-02_Design_v1.pdf
<TeamName>_APS-02_Wireframes.pdf
<TeamName>_APS-02_Architecture.drawio
```
...
3. Confirm the problem statement shown is APS-02. If it is not, stop and contact the organisers — do not upload.
